...
$cek = $con->query("SELECT no_surat FROM cuti ORDER BY id_cuti DESC LIMIT 1")->fetch_array();
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark"><i class="fas fa-calendar-times ml-1 mr-1"></i> Tambah Data Cuti</h4>
                </div><!-- /.col -->
